function [W, b, costHistory] = GradientDescentRegressionR2(x, y, max_iterations, network_shape)

% Validate network shape
if network_shape(1) ~= 2 || network_shape(end) ~= 1
    error('Network shape must begin with 2 and end with 1');
end
